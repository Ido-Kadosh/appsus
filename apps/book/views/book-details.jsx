...
export function BookDetails() {
    ...
    const { thumbnail, reviews, id, title, subtitle, listPrice: { amount, isOnSale, currencyCode }, pageCount, publishedDate, description } = book
    ...
    return (
        <section className="book-details">
            ...
            <button><Link to={`/book/${id}/review`}>Add Review</Link></button>
