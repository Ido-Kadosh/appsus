...
function prepareData(bookFromGoogle) {
    const { volumeInfo: { categories, authors, title, subtitle, description,
        language, pageCount, publishedDate } } = bookFromGoogle

    const book = {
        title, reviews: [], subtitle, description, thumbnail: bookFromGoogle.volumeInfo.imageLinks.thumbnail || '', categories, authors,
        language, publishedDate, pageCount, listPrice: { amount: utilService.getRandomIntInclusive(0, 1000), currencyCode: 'USD' }
    }
    return book
}
